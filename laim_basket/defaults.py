...
# Отброс строк после исчерпания repair — деградация только для меньшинства:
# потеря большей части корзины означает несобранную разметку, а не учёт.
MAX_DROPPED_ROW_SHARE = 0.5
